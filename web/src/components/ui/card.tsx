...
function Card({
    ...
    return (
        <div
            ...
            data-size={size}
            className={cn(
                'group/card flex flex-col gap-(--card-spacing) overflow-hidden border border-primary bg-card py-(--card-spacing) text-sm text-card-foreground ring-1 ring-foreground/5 [--card-spacing:--spacing(4)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(2)] *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none',
                className,
            )}
            {...props}
        />
